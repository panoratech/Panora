          ...
          return (
            <div className="flex flex-row items-center">
              ...
              <div className="ml-2">
                ...
                <Badge
                  variant="secondary"
                  className="rounded-sm px-1 mx-2 font-normal"
                >{`${data.name}`}</Badge>
                has been created
              </div>
            </div>
          ...
          <CustomHeading
            ...
            description={
              <>
                ...
                <a
                  href="https://docs.panora.dev/core-concepts/auth#learn-how-to-generate-your-api-keys-and-catch-connection-tokens"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {" "}
                  More details in <strong>our documentation</strong>
                </a>
                .
              </>
            }
              ...
              {idProject === "" ? (
                ...
                <>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Keep your key safe. <br></br>Save and store this new key
                      to a secure place, such as a password manager or secret
                      store. You will not be able to see it again.
                    </DialogDescription>
                  </DialogHeader>
                              ...
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    ...
                                    placeholder="Your awesome key name"
                                    {...field}
                                  />
                                </FormControl>
                                <FormMessage />
