...
const AddAuthCredentialsForm = (prop : propType) => {
    ...
    const {mutateAsync : fetchCredentials} = useConnectionStrategyAuthCredentialsMutation();
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        const {client_id,client_secret,scope,provider_name,api_key,secret,username} = values
