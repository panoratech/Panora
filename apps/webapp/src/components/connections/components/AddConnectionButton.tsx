...
const AddConnectionButton = ({
  ...
  const [linkedUserMail, setLinkedUserMail] = useState('');
            ...
            {!showNewLinkedUserDialog.import ?
              ( <>
                <div className="space-y-2 items-center gap-4">
                    <Label htmlFor="name">Origin User Identifier</Label>
                    <Input 
                    id="name" 
                ...
                <div className="space-y-2 items-center gap-4">
                    <Label htmlFor="email">Origin User Email</Label>
                    <Input 
                    id="eamil" 
                    placeholder="joedoe@acme.inc" 
                    value={linkedUserMail}
                    onChange={(e) => setLinkedUserMail(e.target.value)}
                    />
                </div>
                </>
              ) : 
