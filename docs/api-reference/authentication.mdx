...
The Panora API uses [API keys](/core-concepts/auth) to authenticate requests. You can view and manage your API keys in the [Panora Dashboard](/core-concepts/auth).
...
You also have to catch a [connection token](/core-concepts/auth) which end-user the request is targeted to.
