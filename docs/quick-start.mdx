...
<Steps titleSize="h3">
  <Step title="No Code: Magic links">
    ...
    <Steps>
      ...
      <Step>
        Go to section _Connections_ and click on button `Create a Magic Link`
      </Step>
...
Drop into our [API documentation](/api-reference/auth/register) for more details on the available endpoints and parameters.
