...
<ResponseField name="event" type="Event Object">
  <Expandable title="properties" defaultOpen="true">
    ...
    <ResponseField name="data" type="json">
      Expect a unified object in this field. A **crm.contact.created** event would for example contain a [`CRM Contact`](/crm/contactss/overview) object.
    </ResponseField>
...
<ResponseField name="Event Types List">
  <Expandable title="properties" defaultOpen="true">
    ...
    <ResponseField name="crm.contact.created">
        Occurs whenever a new contact was created in a CRM. The **data** field is a [`CRM Contact`](/crm/contactss/overview)
    </ResponseField>

    <ResponseField name="crm.contact.updated" >
        Occurs whenever a new contact was updated in a CRM. The **data** field is a [`CRM Contact`](/crm/contactss/overview)
    </ResponseField>

    <ResponseField name="crm.contact.deleted" >
        Occurs whenever a new contact was deleted in a CRM. The **data** field is a [`CRM Contact`](/crm/contactss/overview)
    </ResponseField>
