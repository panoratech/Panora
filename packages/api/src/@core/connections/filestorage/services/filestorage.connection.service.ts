...
@Injectable()
export class FilestorageConnectionsService {
  constructor(
  ...
  async handleFilestorageCallBack(
    providerName: string,
    ...
    try {
      ...
      throwTypedError(
        new ConnectionsError({
          ...
          message:
            'FilestorageConnectionsService.handleFilestorageOAuthCallBack() call failed',
          cause: error,
        }),
        this.logger,
      );
  ...
  async handleFilestorageTokensRefresh(
    connectionId: string,
    providerName: string,
    ...
    try {
      ...
      throwTypedError(
        new ConnectionsError({
          ...
          message:
            'FilestorageConnectionsService.handleFilestorageTokensRefresh() call failed',
          cause: error,
        }),
        this.logger,
      );
