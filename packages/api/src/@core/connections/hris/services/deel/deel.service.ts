...
@Injectable()
export class DeelConnectionService extends AbstractBaseConnectionService {
  ...
  async handleCallback(opts: OAuthCallbackParams) {
    try {
      ...
      const data: DeelOAuthResponse = res.data;
      this.logger.log('OAuth credentials : deel hris ' + JSON.stringify(data));
