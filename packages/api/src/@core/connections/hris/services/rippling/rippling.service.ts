...
@Injectable()
export class RipplingConnectionService extends AbstractBaseConnectionService {
  ...
  async handleCallback(opts: OAuthCallbackParams) {
    try {
      ...
      const res = await axios.post(
        `https://api.rippling.com/api/o/token`,
        formData.toString(),
        {
          headers: {
      ...
      const data: RipplingOAuthResponse = res.data;
      this.logger.log(
        'OAuth credentials : rippling hris ' + JSON.stringify(data),
      );
