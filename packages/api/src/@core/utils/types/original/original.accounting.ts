...
export type AccountingObjectInput =
  ...
  | OriginalCreditNoteInput
  | OriginalExpenseInput
  | OriginalIncomeStatementInput
  | OriginalInvoiceInput
  | OriginalItemInput
  | OriginalJournalEntryInput
  | OriginalPaymentInput
  | OriginalPhoneNumberInput
  | OriginalPurchaseOrderInput
