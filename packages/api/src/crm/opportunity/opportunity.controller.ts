...
export class OpportunityController {
  ...
  @ApiOperation({
    ...
    description: 'Update an existing opportunity in any supported CRM software',
  })
  @ApiParam({
    name: 'id',
    required: true,
    type: String,
    description: 'ID of the opportunity you want to update.',
  })
  @ApiHeader({
    name: 'x-connection-token',
    required: true,
  ...
  async updateOpportunity(
    ...
    try {
      ...
      this.logger.error('Error in updateOpportunity method', error.stack);
      throw new Error(error.message);
    }
  }
  ...
  @ApiOperation({
    ...
    description: 'Delete an existing opportunity from any supported CRM software',
  })
  @ApiParam({
    name: 'id',
    required: true,
    type: String,
    description: 'ID of the opportunity you want to delete.',
  })
  @ApiHeader({
    name: 'x-connection-token',
    required: true,
  ...
  async deleteOpportunity(
    ...
    try {
      ...
      this.logger.error('Error in deleteOpportunity method', error.stack);
      throw new Error(error.message);
    }
  }
}
