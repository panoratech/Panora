/**
 * Represents the response from the Sharepoint API for a specific drive.
 * @see https://learn.microsoft.com/en-us/graph/api/resources/drive?view=graph-rest-1.0
 */
export interface SharepointDriveOutput {
...
export type SharepointDriveInput = Partial<SharepointDriveOutput>;
