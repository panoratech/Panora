import { IdentitySet } from '@filestorage/drive/services/onedrive/types';
import {
  Deleted,
  FileSystemInfo,
  ItemReference,
 ...
 */
export interface OnedriveFileOutput {
...
export type OnedriveFileInput = Partial<OnedriveFileOutput>;
