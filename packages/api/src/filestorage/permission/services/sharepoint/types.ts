...
import { ItemReference } from '@filestorage/folder/services/sharepoint/types';
 ...
 */
export interface SharepointPermissionOutput {
 ...
 * @see https://learn.microsoft.com/en-us/graph/api/driveitem-invite?view=graph-rest-1.0&tabs=http
 */
export interface SharepointPermissionInput {
