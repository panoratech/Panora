 ...
 */
export interface SharepointSharedLinkInput {
...
// Creating a sharing link in one-drive returns a permission.
// ref: https://learn.microsoft.com/en-us/graph/api/driveitem-createlink?view=graph-rest-1.0&tabs=http#response
export type SharepointSharedLinkOutput = Partial<SharepointPermissionOutput>;
