import { OnedriveDriveOutput } from '@filestorage/drive/services/onedrive/types';
 ...
 */
export interface OnedriveUserInput {
   ...
   */
  readonly drive?: OnedriveDriveOutput;
  /**
   * A collection of drives available for this user. Read-only.
   */
  readonly drives?: OnedriveDriveOutput[];
  /**
...
export type OnedriveUserOutput = Partial<OnedriveUserInput>;
