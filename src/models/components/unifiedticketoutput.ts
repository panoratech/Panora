...
/** @internal */
export const UnifiedTicketOutput$inboundSchema: z.ZodType<
    UnifiedTicketOutput,
    z.ZodTypeDef,
    unknown
> = z
...
/** @internal */
export type UnifiedTicketOutput$Outbound = {
    name: string;
    status?: string | undefined;
    description: string;
...
/** @internal */
export const UnifiedTicketOutput$outboundSchema: z.ZodType<
    UnifiedTicketOutput$Outbound,
    z.ZodTypeDef,
    UnifiedTicketOutput
> = z
    .object({
...
export namespace UnifiedTicketOutput$ {
    /** @deprecated use `UnifiedTicketOutput$inboundSchema` instead. */
    export const inboundSchema = UnifiedTicketOutput$inboundSchema;
    /** @deprecated use `UnifiedTicketOutput$outboundSchema` instead. */
    export const outboundSchema = UnifiedTicketOutput$outboundSchema;
    /** @deprecated use `UnifiedTicketOutput$Outbound` instead. */
    export type Outbound = UnifiedTicketOutput$Outbound;
}
