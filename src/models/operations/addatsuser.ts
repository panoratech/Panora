...
export namespace AddAtsUserResponse$ {
    export const inboundSchema: z.ZodType<AddAtsUserResponse, z.ZodTypeDef, unknown> = z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddAtsUserResponse> = z.union([
