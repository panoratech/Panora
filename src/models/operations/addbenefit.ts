...
export namespace AddBenefitResponse$ {
    export const inboundSchema: z.ZodType<AddBenefitResponse, z.ZodTypeDef, unknown> = z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddBenefitResponse> = z.union([
