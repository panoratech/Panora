...
export namespace AddCandidateResponse$ {
    export const inboundSchema: z.ZodType<AddCandidateResponse, z.ZodTypeDef, unknown> = z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddCandidateResponse> = z.union([
