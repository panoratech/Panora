...
export namespace AddCashflowStatementResponse$ {
    export const inboundSchema: z.ZodType<AddCashflowStatementResponse, z.ZodTypeDef, unknown> =
        z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddCashflowStatementResponse> =
        z.union([
