...
export namespace AddCompanyInfoResponse$ {
    export const inboundSchema: z.ZodType<AddCompanyInfoResponse, z.ZodTypeDef, unknown> = z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddCompanyInfoResponse> =
        z.union([
