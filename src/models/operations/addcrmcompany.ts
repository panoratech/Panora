...
export namespace AddCrmCompanyResponse$ {
    export const inboundSchema: z.ZodType<AddCrmCompanyResponse, z.ZodTypeDef, unknown> = z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddCrmCompanyResponse> = z.union(
        [
