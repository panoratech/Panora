...
export namespace AddDealResponse$ {
    export const inboundSchema: z.ZodType<AddDealResponse, z.ZodTypeDef, unknown> = z.union([
        z.lazy(() => AddDealResponseBody$.inboundSchema),
        components.UnifiedDealOutput$.inboundSchema,
    ]);

    export type Outbound = AddDealResponseBody$.Outbound | components.UnifiedDealOutput$.Outbound;
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddDealResponse> = z.union([
