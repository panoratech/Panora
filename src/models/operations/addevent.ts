...
export namespace AddEventResponse$ {
    export const inboundSchema: z.ZodType<AddEventResponse, z.ZodTypeDef, unknown> = z.union([
        components.UnifiedEventOutput$.inboundSchema,
        z.lazy(() => AddEventResponseBody$.inboundSchema),
    ]);

    export type Outbound = components.UnifiedEventOutput$.Outbound | AddEventResponseBody$.Outbound;
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddEventResponse> = z.union([
