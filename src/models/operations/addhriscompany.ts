...
export namespace AddHrisCompanyResponse$ {
    export const inboundSchema: z.ZodType<AddHrisCompanyResponse, z.ZodTypeDef, unknown> = z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddHrisCompanyResponse> =
        z.union([
