...
export namespace AddPurchaseOrderResponse$ {
    export const inboundSchema: z.ZodType<AddPurchaseOrderResponse, z.ZodTypeDef, unknown> =
        z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddPurchaseOrderResponse> =
        z.union([
