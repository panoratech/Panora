...
export namespace AddScoreCardResponse$ {
    export const inboundSchema: z.ZodType<AddScoreCardResponse, z.ZodTypeDef, unknown> = z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddScoreCardResponse> = z.union([
