...
export namespace AddTaskResponse$ {
    export const inboundSchema: z.ZodType<AddTaskResponse, z.ZodTypeDef, unknown> = z.union([
        z.lazy(() => AddTaskResponseBody$.inboundSchema),
        components.UnifiedTaskOutput$.inboundSchema,
    ]);

    export type Outbound = AddTaskResponseBody$.Outbound | components.UnifiedTaskOutput$.Outbound;
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddTaskResponse> = z.union([
