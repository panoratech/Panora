...
export namespace AddTaxRateResponse$ {
    export const inboundSchema: z.ZodType<AddTaxRateResponse, z.ZodTypeDef, unknown> = z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddTaxRateResponse> = z.union([
