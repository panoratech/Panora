...
export namespace AddTransactionResponse$ {
    export const inboundSchema: z.ZodType<AddTransactionResponse, z.ZodTypeDef, unknown> = z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AddTransactionResponse> =
        z.union([
