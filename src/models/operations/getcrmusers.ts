...
export type GetCrmUsersResponse = {
    ...
    object?: GetCrmUsersResponseBody | undefined;
};
...
/** @internal */
export namespace GetCrmUsersResponse$ {
    export const inboundSchema: z.ZodType<GetCrmUsersResponse, z.ZodTypeDef, unknown> = z
        .object({
            HttpMeta: components.HTTPMetadata$.inboundSchema,
            object: z.lazy(() => GetCrmUsersResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return remap$(v, {
                HttpMeta: "httpMeta",
    ...
    export type Outbound = {
        ...
        object?: GetCrmUsersResponseBody$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCrmUsersResponse> = z
        .object({
            httpMeta: components.HTTPMetadata$.outboundSchema,
            object: z.lazy(() => GetCrmUsersResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return remap$(v, {
                httpMeta: "HttpMeta",
