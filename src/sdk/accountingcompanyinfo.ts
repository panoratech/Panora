...
export class AccountingCompanyinfo extends ClientSDK {
    ...
    async getCompanyInfos(
        ...
        const [result$] = await this.matcher<operations.GetCompanyInfosResponseBody>()
            .json(200, operations.GetCompanyInfosResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async addCompanyInfo(
        ...
        const [result$] = await this.matcher<operations.AddCompanyInfoResponse>()
            .json(200, operations.AddCompanyInfoResponse$)
            .json(201, operations.AddCompanyInfoResponse$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getCompanyInfo(
        ...
        const [result$] = await this.matcher<operations.GetCompanyInfoResponseBody>()
            .json(200, operations.GetCompanyInfoResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
