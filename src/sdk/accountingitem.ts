...
export class AccountingItem extends ClientSDK {
    ...
    async getItems(
    ...
    ): Promise<operations.GetItemsResponseBody> {
        const input$ = request;
        ...
        const [result$] = await this.matcher<operations.GetItemsResponseBody>()
            .json(200, operations.GetItemsResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async addItem(
        ...
        const [result$] = await this.matcher<operations.AddItemResponse>()
            .json(200, operations.AddItemResponse$inboundSchema)
            .json(201, operations.AddItemResponse$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getItem(
        ...
        options?: RequestOptions
    ): Promise<operations.GetItemResponseBody> {
        const input$ = request;
        ...
        const [result$] = await this.matcher<operations.GetItemResponseBody>()
            .json(200, operations.GetItemResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
