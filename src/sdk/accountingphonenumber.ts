...
export class AccountingPhonenumber extends ClientSDK {
    ...
    async getPhoneNumbers(
        ...
        const [result$] = await this.matcher<operations.GetPhoneNumbersResponseBody>()
            .json(200, operations.GetPhoneNumbersResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async addPhoneNumber(
        ...
        const [result$] = await this.matcher<operations.AddPhoneNumberResponse>()
            .json(200, operations.AddPhoneNumberResponse$inboundSchema)
            .json(201, operations.AddPhoneNumberResponse$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getPhoneNumber(
        ...
        const [result$] = await this.matcher<operations.GetPhoneNumberResponseBody>()
            .json(200, operations.GetPhoneNumberResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
