...
export class AccountingTaxrate extends ClientSDK {
    ...
    async getTaxRates(
        ...
        const [result$] = await this.matcher<operations.GetTaxRatesResponseBody>()
            .json(200, operations.GetTaxRatesResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async addTaxRate(
        ...
        const [result$] = await this.matcher<operations.AddTaxRateResponse>()
            .json(200, operations.AddTaxRateResponse$)
            .json(201, operations.AddTaxRateResponse$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getTaxRate(
        ...
        const [result$] = await this.matcher<operations.GetTaxRateResponseBody>()
            .json(200, operations.GetTaxRateResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
