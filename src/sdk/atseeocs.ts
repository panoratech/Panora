...
export class AtsEeocs extends ClientSDK {
    ...
    async getEeocss(
        ...
        const [result$] = await this.matcher<operations.GetEeocssResponseBody>()
            .json(200, operations.GetEeocssResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async addEeocs(
        ...
        const [result$] = await this.matcher<operations.AddEeocsResponse>()
            .json(200, operations.AddEeocsResponse$)
            .json(201, operations.AddEeocsResponse$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getEeocs(
        ...
        const [result$] = await this.matcher<operations.GetEeocsResponseBody>()
            .json(200, operations.GetEeocsResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
