...
export class CrmEngagements extends ClientSDK {
    ...
    async getEngagements(
        ...
        const [result$] = await this.matcher<operations.GetEngagementsResponseBody>()
            .json(200, operations.GetEngagementsResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async addEngagement(
        ...
        const [result$] = await this.matcher<operations.AddEngagementResponse>()
            .json(200, operations.AddEngagementResponse$)
            .json(201, operations.AddEngagementResponse$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getEngagement(
        ...
        const [result$] = await this.matcher<operations.GetEngagementResponseBody>()
            .json(200, operations.GetEngagementResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
