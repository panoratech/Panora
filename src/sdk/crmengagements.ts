...
export class CrmEngagements extends ClientSDK {
    ...
    async getEngagements(
    ...
    ): Promise<operations.GetEngagementsResponseBody> {
        const input$ = request;
        ...
        const [result$] = await this.matcher<operations.GetEngagementsResponseBody>()
            .json(200, operations.GetEngagementsResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async addEngagement(
        ...
        const [result$] = await this.matcher<operations.AddEngagementResponse>()
            .json(200, operations.AddEngagementResponse$inboundSchema)
            .json(201, operations.AddEngagementResponse$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getEngagement(
        ...
        options?: RequestOptions
    ): Promise<operations.GetEngagementResponseBody> {
        const input$ = request;
        ...
        const [result$] = await this.matcher<operations.GetEngagementResponseBody>()
            .json(200, operations.GetEngagementResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
