...
export class FilestorageFolder extends ClientSDK {
    ...
    async getFolders(
        ...
        const [result$] = await this.matcher<operations.GetFoldersResponseBody>()
            .json(200, operations.GetFoldersResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async addFolder(
        ...
        const [result$] = await this.matcher<operations.AddFolderResponse>()
            .json(200, operations.AddFolderResponse$)
            .json(201, operations.AddFolderResponse$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getFolder(
        ...
        const [result$] = await this.matcher<operations.GetFolderResponseBody>()
            .json(200, operations.GetFolderResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
