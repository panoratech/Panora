...
export class HrisEmployment extends ClientSDK {
    ...
    async getEmployments(
        ...
        const [result$] = await this.matcher<operations.GetEmploymentsResponseBody>()
            .json(200, operations.GetEmploymentsResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async addEmployment(
        ...
        const [result$] = await this.matcher<operations.AddEmploymentResponse>()
            .json(200, operations.AddEmploymentResponse$)
            .json(201, operations.AddEmploymentResponse$)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getEmployment(
        ...
        const [result$] = await this.matcher<operations.GetEmploymentResponseBody>()
            .json(200, operations.GetEmploymentResponseBody$)
            .fail(["4XX", "5XX"])
            .match(response);
