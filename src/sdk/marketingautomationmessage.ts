...
export class MarketingautomationMessage extends ClientSDK {
    ...
    async getMessages(
        ...
        const [result$] = await this.matcher<operations.GetMessagesResponseBody>()
            .json(200, operations.GetMessagesResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async addMessage(
        ...
        const [result$] = await this.matcher<operations.AddMessageResponse>()
            .json(200, operations.AddMessageResponse$inboundSchema)
            .json(201, operations.AddMessageResponse$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getMessage(
        ...
        const [result$] = await this.matcher<operations.GetMessageResponseBody>()
            .json(200, operations.GetMessageResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
