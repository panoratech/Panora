...
export class Passthrough extends ClientSDK {
    ...
    async passthroughRequest(
    ...
    ): Promise<operations.PassthroughRequestResponse> {
        const input$: operations.PassthroughRequestRequest = {
        ...
        const [result$] = await this.matcher<operations.PassthroughRequestResponse>()
            .json([200, 201], operations.PassthroughRequestResponse$, {
