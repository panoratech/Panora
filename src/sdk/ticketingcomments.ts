...
export class TicketingComments extends ClientSDK {
    ...
    async getComments(
        ...
        const [result$] = await this.matcher<operations.GetCommentsResponseBody>()
            .json(200, operations.GetCommentsResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async addComment(
        ...
        const [result$] = await this.matcher<operations.AddCommentResponse>()
            .json(200, operations.AddCommentResponse$inboundSchema)
            .json(201, operations.AddCommentResponse$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getComment(
        ...
        const [result$] = await this.matcher<operations.GetCommentResponseBody>()
            .json(200, operations.GetCommentResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
