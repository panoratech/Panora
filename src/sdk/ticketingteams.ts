...
export class TicketingTeams extends ClientSDK {
    ...
    async getTeams(
        ...
        const [result$] = await this.matcher<operations.GetTeamsResponseBody>()
            .json(200, operations.GetTeamsResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getTeam(
        ...
        const [result$] = await this.matcher<operations.GetTeamResponseBody>()
            .json(200, operations.GetTeamResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
