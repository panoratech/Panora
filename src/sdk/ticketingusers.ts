...
export class TicketingUsers extends ClientSDK {
    ...
    async getTicketingUsers(
    ...
    ): Promise<operations.GetTicketingUsersResponseBody> {
        const input$ = request;
        ...
        const [result$] = await this.matcher<operations.GetTicketingUsersResponseBody>()
            .json(200, operations.GetTicketingUsersResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
    ...
    async getTicketingUser(
        ...
        options?: RequestOptions
    ): Promise<operations.GetTicketingUserResponseBody> {
        const input$ = request;
        ...
        const [result$] = await this.matcher<operations.GetTicketingUserResponseBody>()
            .json(200, operations.GetTicketingUserResponseBody$inboundSchema)
            .fail(["4XX", "5XX"])
            .match(response);
